...
def get_argparser():
    ...
    parser.add_argument("--l_ptr", type=str, default = 'F')
    parser.add_argument("--jobid", type=int, default = 555555)
    parser.add_argument("--encoder", type=str, default = 'cnn') #cnn or lstmM
    parser.add_argument("--attr_alg", type=str, default = 'IG') #IG, GS, GN
    parser.add_argument("--seeds", type=int, default = 1)
    parser.add_argument("--fold_v", type=int, default = 1)
    parser.add_argument("--j_file", type=str, default = 'output.txt') 
    
    parser.add_argument("--samples", type=int, default = 1500)  #dataset size
    parser.add_argument("--tp", type=int, default = 140)  #time points
    parser.add_argument("--ws", type=int, default = 20)  #window shift
    parser.add_argument("--nw", type=int, default = 7)  #number of windows
    parser.add_argument("--wsize", type=int, default = 20)  #number of windows
    parser.add_argument("--convsize", type=int, default = 2400)  #number of windows

    parser.add_argument("--epp", type=int, default = 2)  #epochs

    parser.add_argument("--gainn", type=float, default = 0.9)  #gain value
    parser.add_argument("--daata", type=str)
    ...
    parser.add_argument(
        "--lr",
        type=float,
        #default=3e-4, #original default used 3e-4
        #default=5e-4,
        default=7e-4, #used for the highest results on downstream
